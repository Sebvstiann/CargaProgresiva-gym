    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('peso', models.FloatField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0, message='El peso debe ser un número positivo')])),
                ('altura', models.FloatField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0, message='La altura debe ser un número positivo')])),
                ('edad', models.IntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0, message='La edad debe ser un número positivo')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rendimiento_percibido', models.IntegerField(choices=[(1, '😫 Muy Malo'), (2, '😞 Malo'), (3, '😐 Regular'), (4, '😊 Bueno'), (5, '🤩 Excelente')], default=3)),
